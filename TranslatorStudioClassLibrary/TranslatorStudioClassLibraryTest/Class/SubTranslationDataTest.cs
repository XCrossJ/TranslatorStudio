...
{
    /// <summary>
    /// Contains tests to run against Sub Translation Data class.
    /// </summary>
    [Collection("Sub Translation Data Test")]
    public class SubTranslationDataTest
    {
        /// <summary>
        /// Contains tests to run against Sub Translation Data properties.
        /// </summary>
        [Trait("Category", "Unit")]
        ...
        /// <summary>
        /// Contains tests to run against Sub Translation Data constructors.
        /// </summary>
        [Trait("Category", "Unit")]
        [Trait("Class", "Sub Translation Data")]
